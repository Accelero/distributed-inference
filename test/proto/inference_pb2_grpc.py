...
class WorkerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Heartbeat = channel.unary_unary(
                ...
                request_serializer=proto_dot_inference__pb2.HeartbeatRequest.SerializeToString,
...
def add_WorkerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Heartbeat': grpc.unary_unary_rpc_method_handler(
                    servicer.Heartbeat,
                    request_deserializer=proto_dot_inference__pb2.HeartbeatRequest.FromString,
                    response_serializer=proto_dot_inference__pb2.HeartbeatResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'inference.Worker', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('inference.Worker', rpc_method_handlers)
...
class Worker(object):
    ...
    def Heartbeat(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/inference.Worker/Heartbeat',
            proto_dot_inference__pb2.HeartbeatRequest.SerializeToString,
...
def add_CoordinatorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'inference.Coordinator', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('inference.Coordinator', rpc_method_handlers)
